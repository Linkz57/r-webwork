...
<html> \
	...
	<body> \
		...
		<p><br><br></p><hr><p><br></p> \
		<div class=\"header\">In the area of 'High Expectations" + mh2 + "5" + mh3 + "T1 through T5, with T1 and T3 being non-negotiables, expected to be observed each visit</div> \
		<p><br></p> \
		<div class=\"results\">" + s0 + " " + mh1 + "Quality Planning" +mh2 + "6" + mh3 + "T6 through T11, with T7" + mh4 + " " + s1 + "</div> \
		<p><br><br></p><hr><p><br><br></p> \
		<div class=\"header\">In the area of 'Lesson Delivery" + mh2 + "12" + mh3 + "T12 through T21, with T15" + mh4 + " " + s2 + " " + mh1 + "Student Engagement" + mh2 + "6" + mh3 + "T22 through T27, with T22 and T26" + mh4 + " " + s3 + " " + mh1 + "Classroom Culture" + mh2 + "8" + mh3 + "T28 through T35</div> \
		<p><br></p> \
		<div class=\"results\">" + s4 + " " + mh1 + "Student Behavior" + mh2 + "7" + mh3 + "T36 through T42</div> \
		<p><br></p> \
		<div class=\"results\">" + s5 + " " + mh1 + "Building Character and Trust" + mh2 + "7" + mh3 + "T36 through T42</div> \
		<p><br></p> \
		<div class=\"results\">" + s6 +  " " + mh1 + "CKH Implementation Activities" + mh2 + "4" + mh3 + "Number one: Social Contract</div> \
		<p><br></p><div class=\"results\">" + s7 + " " + mh1 + "CKH Implementation Activities" + mh2 + "4" + mh3 + "Number Two: Building Relational Capacity</div> \
		<p><br></p> \
		<div class=\"results\">" + s8 + " " + mh1 + "CKH Implementation Activities" + mh2 + "4" + mh3 + "Number Three: Discipline Model</div> \
		<p><br></p> \
		<div class=\"results\">" + s9 + "</div> \
		<p><br><br></p><hr><p><br><br></p> \
		<div class=\"header\">MYP Implementation Activities</div> \
		<p><br></p><div class=\"results\">" + sb5 + "</div> \
		<p><br><br></p><hr><p><br><br> \
		<div class=\"header\">HQT Constructive Feedback" + mh3 + "This is what would otherwise be the 'second page'.</div> \
		<p><br></p> \
		<div class=\"results\">" + sb4 + "</div> \
		<p><br><br></p><hr><p><br><br></p> \
